...
// --- configuraton / konfiguracja ---/// COPY HERE <cfg> // configuration end / koniec konfiguracji// FIX: Zmienna globalna do sprawdzania trybu offlineconst isOffline = window.location.protocol === "file:";
