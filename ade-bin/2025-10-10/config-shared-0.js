const config = {
  // Global settings for all subsystems / Globalne ustawienia dla wszystkich podsystemów
  version: "v2.2.3", // Folder structure update
  build: "2025-09-17", // Build date YYYY-MM-DD
  updated: "2025-10-07", // Last update date YYYY-MM-DD
  ...
  pageSettings: { 
    ...
    // Local settings for this subsystem only / Ustawienia lokalne tylko dla tego podsystemu
    // This settings can be overridden in ade-subsystem/js/config.js / Ustawienia te mogą być nadpisane w ade-subsystem/js/config.js
